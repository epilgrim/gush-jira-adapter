...
class JiraIssueTracker extends BaseIssueTracker
{
    ...
    {
        return sprintf('%s/issue/%s', $this->url, $id);
    }
    ...
    protected function adaptIssueStructure(array $issue)
    {
        return [
            ...
            'labels' => isset($issue['fields']['labels'])? $issue['fields']['labels'] : [],
            'assignee' => $issue['fields']['assignee']['name'],
            'milestone' => count($issue['fields']['versions']) > 0 ? $issue['fields']['versions'][0] : null,
            'created_at' => new \DateTime($issue['fields']['created']),
            'updated_at' => new \DateTime($issue['fields']['updated']),
            'closed_by' => $issue['fields']['assignee']['name'],
            'pull_request' => false,
        ];
    }
